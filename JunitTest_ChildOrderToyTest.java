 ...
 * 
 * Be sure to also read the Lab7 instructions PDF carefully
 * 
...
public class JunitTest_ChildOrderToyTest {
	...
	public void test_2_0() {
		 ...
		 * 
		 */
		Toy[] childToysList = c.getChildToys();
		...
		String errorMsg4 = String.format("\n Test getChildToys failed. Returned nul but did not ");
		...
		errorMsg4 = String.format("\n Test getChildToys failed. Returned array of length (%d) " + "but correct is  (%d)",
	...
	public void test_2_1() {
		...
		assertTrue(c1.getChildToys().length == 2 && c1.getChildToys()[0] != t1 && c1.getChildToys()[1] != t2);
		assertTrue(c1.getChildToys().length == 2 && c1.getChildToys()[0].getToyName().equals("Red Bike")
				&& c1.getChildToys()[1].getToyName().equals("Colouring Book"));

		assertTrue(c1.getChildToys().length == 2 && c1.getChildToys()[0].getToyQuantity() == 3
				&& c1.getChildToys()[1].getToyQuantity() == 4);
		...
		assertTrue(c2.getChildToys().length == 2 && c2.getChildToys()[0] != t1 && c2.getChildToys()[1] != t2);
		assertTrue(c2.getChildToys().length == 2 && c2.getChildToys()[0].getToyName().equals("Red Bike")
				&& c2.getChildToys()[1].getToyName().equals("Colouring Book"));

		assertTrue(c2.getChildToys().length == 2 && c2.getChildToys()[0].getToyQuantity() == 3
				&& c2.getChildToys()[1].getToyQuantity() == 4);

		// Verify that the toys owned by c1 are different from the toys owned by c2
		assertTrue(c2.getChildToys()[0] != c1.getChildToys()[0] && c1.getChildToys()[1] != c2.getChildToys()[1]);
	...
	public void test_2_5() {
		...
		/*
		 * Length of the returned array from getChildToys corresponds to the number of
		 * toys inside listofToy which is zero.
		 * 
		 */
		Toy[] childToysList = c1.getChildToys();
		...
		errorMsg4 = String.format("\n Test getChildToys failed. Returned null but did not ");
		assertTrue(errorMsg4, childToysList == null);
	...
	public void test_3_0() {
		...
		ChildOrderToy o1 = new ChildOrderToy();
		/* The order empty there is no children */
		...
		String expOrderStr = "The order contains 0 children";
		...
		expOrderStr = "The order contains 1 children";
		errorMsg5 = String.format("\n Test toString failed. Returned (%s) " + "but correct is  (%s)", orderstr,
				expOrderStr);
		assertEquals(errorMsg5, expOrderStr, orderstr);
		...
		assertTrue(o1.getChildren().length == 1 && o1.getChildren()[0] == c1);

		assertTrue(o1.getChildren().length == 1 && o1.getChildren()[0].getChildName().equals("Sophia"));

		// add more children
		o1.addChildtoOrder(c2);
		o1.addChildtoOrder(c10);
		assertTrue(o1.getChildren().length == 3 && o1.getChildren()[0] == c1 && o1.getChildren()[1] == c2
				&& o1.getChildren()[2] == c10);

		assertTrue(o1.getChildren().length == 3 && o1.getChildren()[0].getChildName().equals("Sophia")
				&& o1.getChildren()[1].getChildName().equals("Harper")
				&& o1.getChildren()[2].getChildName().equals("Mila"));

		orderstr = o1.toString();
		

		expOrderStr = "The order contains 3 children";
		errorMsg5 = String.format("\n Test toString failed. Returned (%s) " + "but correct is  (%s)", orderstr,
				expOrderStr);
		assertEquals(errorMsg5, expOrderStr, orderstr);
		...
		assertTrue(o1.getChildren().length == 2 && o1.getChildren()[0] == c1 && o1.getChildren()[1] == c10);

		assertTrue(o1.getChildren().length == 2 && o1.getChildren()[0].getChildName().equals("Sophia")

				&& o1.getChildren()[1].getChildName().equals("Mila"));
		...
		assertTrue(o1.getChildren().length == 5 && o1.getChildren()[0] == c1 && o1.getChildren()[1] == c10
				&& o1.getChildren()[2] == c9 && o1.getChildren()[3] == c3 && o1.getChildren()[4] == c4);
		...
		expOrderStr = "The order contains 5 children";
		errorMsg5 = String.format("\n Test toString failed. Returned (%s) " + "but correct is  (%s)", orderstr,
				expOrderStr);
		assertEquals(errorMsg5, expOrderStr, orderstr);
		...
		assertTrue(o1.getChildren().length == 4 && o1.getChildren()[0] == c1 && o1.getChildren()[1] == c10
				&& o1.getChildren()[2] == c9 && o1.getChildren()[3] == c4);
		// remove more child
		o1.removeChildfromOrder(c1);
		o1.removeChildfromOrder(c9);
		assertTrue(o1.getChildren().length == 2 && o1.getChildren()[0] == c10 && o1.getChildren()[1] == c4);
		
		// add more children again
		o1.addChildtoOrder(c6);
		o1.addChildtoOrder(c5);
		o1.addChildtoOrder(c7);
		o1.addChildtoOrder(c8);
		assertTrue(o1.getChildren().length == 5 && o1.getChildren()[0] == c10 && o1.getChildren()[1] == c4
				&& o1.getChildren()[2] == c6 && o1.getChildren()[3] == c5 && o1.getChildren()[4] == c7);
		
		assertTrue(o1.getChildren().length == 5 && o1.getChildren()[0].getChildName().equals("Mila")
				&& o1.getChildren()[1].getChildName().equals("Levi")
				&& o1.getChildren()[2].getChildName().equals("Leo")
				&& o1.getChildren()[3].getChildName().equals("Luca")
				&& o1.getChildren()[4].getChildName().equals("Oliver"));
